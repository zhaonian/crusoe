...
class ModelDownloader {
  ...
  static Future<String> downloadModel({
    ...
    try {
      ...
      String? modelPath = await _getBundledModelPath(
        onProgress,
        onStatusUpdate,
      );
      if (modelPath != null) {
      ...
      throw Exception(
        'Real model download not implemented. Please include model in assets/models/',
      );
    } catch (e) {
  ...
  static Future<String?> _getBundledModelPath([
    ...
    try {
      ...
      try {
        ...
        debugPrint(
          '📁 Found bundled model, size: ${assetData.lengthInBytes} bytes',
        );
        ...
        debugPrint(
          '📁 Original size: ${assetData.lengthInBytes}, Copied size: $copiedSize',
        );
